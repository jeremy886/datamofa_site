...
BLOG_AUTHOR = "Jeremy Chen"  # (translatable)
BLOG_TITLE = "Learning and Teaching Big Data"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.datamofa.club/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.datamofa.club/"
BLOG_EMAIL = "datamofa@jeremychen.email"
BLOG_DESCRIPTION = "Magic in Data"  # (translatable)
